...
public class DeviceControlActivity extends AppCompatActivity {
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                //Connect DataBase
                //new InsertAsync().execute("http://192.168.1.89/sensor_temp/get_data.php");
                new InsertAsync().execute("http://10.109.172.5/sensor_temp/get_data.php");
            }
        }
    };
    ...
    class InsertAsync extends AsyncTask<String, Void, Void> {
        ...
        String valor = DeviceControlActivity.value;
        ...
        protected Void doInBackground(String... params) {
            ...
            body = new FormEncodingBuilder().add("temp", valor).build();
